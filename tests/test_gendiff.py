...
FILE1_JSON, FILE2_JSON = ("tests/test_data/file1.json", "tests/test_data/file2.json")

FILE1_YAML, FILE2_YAML = ("tests/test_data/file1.yml", "tests/test_data/file2.yml")
...
def test_gen():
    ...
    assert generate_diff(FILE1_DEEP_JSON, FILE2_DEEP_JSON, "plain") == DIFF_DEEP_PLAIN
    assert generate_diff(FILE1_DEEP_YAML, FILE2_DEEP_YAML, "plain") == DIFF_DEEP_PLAIN
    assert generate_diff(FILE1_DEEP_JSON, FILE2_DEEP_JSON, "json") == DIFF_DEEP_JSON
